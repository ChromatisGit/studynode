...
import styles from "../textTask/styles.module.css";
import MACROS_TEXT from "@macros/macros.de.json";

type Props = MacroComponentProps<MathTaskMacro>;

export default function MathTaskRenderer({ macro, context }: Props) {
  ...
  return (
    <Stack gap="md">
      ...
      <textarea
        ...
        rows={3}
        placeholder={MACROS_TEXT.mathTask.placeholder}
      />
