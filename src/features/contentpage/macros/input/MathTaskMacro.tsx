...
import type { MathTaskMacro as MathTaskMacroType } from "@domain/macroTypes";
...
import styles from "./MathTaskMacro.module.css";

type Props = MacroComponentProps<MathTaskMacroType>;

export function MathTaskMacro({ macro, context }: Props) {
