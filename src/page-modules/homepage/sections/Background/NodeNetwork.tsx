...
import type { Connection, Vec2 } from '@pages/homepage/sections/Background/nodeNetworkHelpers';
import {
  generateNodes,
  getNodeCount,
  generateConnections,
  ...
  isConnectionActive,
} from '@pages/homepage/sections/Background/nodeNetworkHelpers';
import styles from '@pages/homepage/sections/Background/NodeNetwork.module.css';
